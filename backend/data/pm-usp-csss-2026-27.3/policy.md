...
Policy version: `pm-usp-csss-2026-27.3`

Verification date: 2026-09-19

Revision note: SevaFix now compares the income declared in the application with the value extracted and confirmed from the required family income certificate. This is a consistency check; no official eligibility threshold changed.
...
- The declared income and the uploaded family income certificate must agree before SevaFix marks the application ready.
